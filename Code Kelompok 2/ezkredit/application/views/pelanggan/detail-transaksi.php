                                ...
                                <div class="table-responsive">
                                    <div class="col-sm-2">
                                        <ul class="list-group list-group-flush">
                                            ...
                                            <li class="list-group-item">kode pegawai</li>
                                            <li class="list-group-item">deskripsi</li>
                                        <br><br><br><br>
                                        <div class="mbr-section-btn"><a class="btn btn-md btn-warning display-4" style="width:75%"  href="<?php echo base_url(); ?>cid/hasilquery/<?= $data->token ?>">Back</a></div>
                                        </ul>
                                    </div>
                                    <div class="col-sm-4">
                                        <ul class="list-group list-group-flush">
                                            ...
                                            <li class="list-group-item">: <?= $data->nominal ?></li>
                                            <li class="list-group-item">: <?= $data->tanggal ?></li>
                                            <li class="list-group-item">: <?= $data->kode_pegawai ?></li>
                                    ...
                                    <div class="col-sm-5">
                                        <ul class="list-group list-group-flush">
                                            <li class="list-group-item">
                                                <img width="100%" class="img-fluid" src="<?= base_url()?>assets/images/upload/transaksi/<?= $data->kode ?>.jpg" alt="">
                                            </li>
                                        </ul>
                                        </div>
                                </div>
