								...
								&nbsp &nbsp &nbsp <img src="<?php echo base_url(); ?>assets/images/logo1.png" alt="Mobirise" title="" style="height: 3.5rem"><br><br>
                                        ...
                                        <div class="col-sm-4">
                                            <ul class="list-group list-group-flush">
                                                ...
                                                <?php if($data -> statktp == 1){ ?> 
                                                    Diterima
                                                <?php }
                                                else if($data -> statktp == 2){ ?> 
                                                    Ditolak
                                                <?php }else if($data -> statktp == 0){ ?>
                                                    Belom diperiksa
                                                <?php } ?>
                                                </li>
                                                <li class="list-group-item">:
                                                <?php if($data -> statslip == 1){ ?> 
                                                    Diterima
                                                <?php }
                                                else if($data -> statslip == 2){ ?> 
                                                    Ditolak
                                                <?php }else if($data -> statslip == 0){ ?>
                                                    Belom diperiksa
                                                <?php } ?>
                                                </li>
                                                
                                                <li class="list-group-item">:
                                                <?php if($data -> statkk == 1){ ?> 
                                                    Diterima
                                                <?php }
                                                else if($data -> statkk == 2){ ?> 
                                                    Ditolak
                                                <?php }else if($data -> statkk == 0){ ?>
                                                    Belom diperiksa
                                                <?php } ?>
                                                </li>
                                                
                                                <li class="list-group-item">:
                                                <?php if($data -> statjaminan == 1){ ?> 
                                                    Diterima
                                                <?php }
                                                else if($data -> statjaminan == 2){ ?> 
                                                    Ditolak
                                                <?php }else if($data -> statjaminan == 0){ ?>
                                                    Belom diperiksa
                                                <?php } ?>
                                                </li>
												<br><br>
												<li class="list-group-item">: Data Anda Belum Selesai Kami Proses!!</li>
                                            </ul>
                                        </div>
										<div class="col-sm-4"> 
											<ul class="list-group list-group-flush">
											<li class="list-group-item"><img src="<?php echo base_url(); ?>assets/images/periksa.png" alt="Mobirise" title="" style="height: 25.0rem"></li>
										</div>
	                              </div>
                            </div>
                        </div>
