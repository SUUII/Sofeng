                    ...
                    <div class="row">
                        <div class="col-sm-12" style="font-size: 18px">
                            <div class="card-box">
								...
								&nbsp &nbsp &nbsp <img src="<?php echo base_url(); ?>assets/images/logo1.png" alt="Mobirise" title="" style="height: 3.5rem"><br>
                                        <br><div class="col-sm-2">
                                            <ul class="list-group list-group-flush">
                                                ...
                                                <li class="list-group-item">Kelebihan</li>
                                                <br><br>
                                            ...
                                            <ul class="list-group list-group-flush">
                                                ...
                                                <li class="list-group-item">: <?php if($total-$data->hutang != 0){echo $total-$data->hutang;} ?></li>
												<br><br>
												<li class="list-group-item">: LUNAS!!!</li>
											</ul>
											</div>
										<div class="col-sm-4"> 
											<ul class="list-group list-group-flush">
											<li class="list-group-item"><img src="<?php echo base_url(); ?>assets/images/diterima.jpg" alt="Mobirise" title="" style="height: 30.0rem"></li>
										</div>
                                </div>
                            </div>
                        </div>
