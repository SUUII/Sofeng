								...
								&nbsp &nbsp &nbsp <img src="<?php echo base_url(); ?>assets/images/logo1.png" alt="Mobirise" title="" style="height: 3.5rem"><br><br>
                                        ...
                                        <div class="col-sm-4">
                                            <ul class="list-group list-group-flush">
												...
												<br><br>
												<li class="list-group-item">: Permohonan kami tolak!!</li>
                                            </ul>
                                        </div>
										<div class="col-sm-4"> 
											<ul class="list-group list-group-flush">
											<li class="list-group-item"><img src="<?php echo base_url(); ?>assets/images/ditolak.png" alt="Mobirise" title="" style="height: 25.0rem"></li>
										</div>
	                              </div>
                            </div>
                        </div>
