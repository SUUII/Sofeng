                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-10 col-md-offset-1">
                            <div class="p-6">
                                <div class="">
                                    <form action="<?php echo site_url('admin/manage_transaksi/add/' . $token) ?>" method="post" enctype="multipart/form-data">
                                        <div class="form-group m-b-20">
                                            <label for="exampleInputEmail1">Nominal</label>
                                            <input type="number" class="form-control" id="nominal" name="nominal" placeholder="Masukan Nominal Pembayaran" required>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="card-box">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="card-box">
                                                    <h4 class="m-b-30 m-t-0 header-title"><b>Bukti Pembayaran</b></h4>
                                                    <input type="file" class="form-control" id="gambarbukti" name="gambarbukti" required="">
                                                </div>
                                            </div>
                                        </div>
