                        ...
                        <div class="col-sm-12">
                            <div class="card-box">
                                <div class="table-responsive">
                                    ...
                                    <?php } ?>
                                    <form action="<?php echo site_url('admin/manage_transaksi/query/') ?>" class="form-inline" method="post">
                                      <div class="form-group mx-sm-3 mb-2">
                                        <label for="kode" class="sr-only">kode</label>
                                        <input type="text" class="form-control" id="kode" name='kode' placeholder="masukan kode" style="width: 100%px;border-radius: 20px">
                                      </div>
                                      <button type="submit" class="btn btn-primary mb-2">Cari Transaksi</button>
                                    </form>
                                    <br>
